...
export default function Home() { return ( <main className="flex min-h-screen flex-col items-center justify-center bg-black text-white"> <div className="relative w-full h-screen overflow-hidden"> <Image
src="/bg-stars.jpg"
alt="Starry Background"
layout="fill"
objectFit="cover"
quality={100}
/> <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center"> <Image
src="/husky-shiba-rocket.png"
alt="Husky and Shiba Rocket"
width={300}
height={300}
className="mb-6"
/> <h1 className="text-5xl font-bold mb-4">To the Moon, the Shibsky Way!</h1> <p className="text-xl max-w-2xl mb-6"> Meet Husky & Shiba on their unlimited meme-fueled rocket journey to the moon. Powered by hype, love, and memes. </p> <div className="flex gap-4"> <a
href="#"
...
<div className="mt-16 max-w-4xl w-full px-6">
    ...
    <p className="text-lg">
      Shibsky was born when a Husky and a Shiba Inu decided to ride a rocket together.
      Their goal? Spread memes, love, and rich vibes across the galaxy. Built by the community, for the community.
    </p>
  </div>
